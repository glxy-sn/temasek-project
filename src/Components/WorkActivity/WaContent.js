...
import AddWa from './CreateNewWa/AddWa'

const WaContent = ({title, table, data, ...props}) => {
    ...
    return (
        <>
            {!showTambah && (
                <div className='content-wrapper w-100 bg-light rounded pb-4 mb-5'>
                    ...
                    <div className='mx-4 mt-3 mb-4'>
                        {/* <WaTable title={title} tableHead={table} data={data?.content}/> */}
                    </div>
            ...
            {showTambah && (
                <div>
                    <div className="w-100">
                        <AddWa setShowTambah={setShowTambah}/>
                    </div>
                </div>
            )}
        </>
